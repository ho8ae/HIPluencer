...
<%@ page import="community.SearchBean"%>
<!DOCTYPE html>
<html lang="en">
							...
							<div class="card-body">
								<div class="row mb-2">
									<div class="col-md-8 d-flex align-items-center">
										<h1 class="h3 mb-2 fw-bold text-hipluncer">행사 공유소</h1>
									</div>
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-12">
												<form id="searchForm" method="GET" action="./searchShare.jsp">
													<div
			...
			<div id="board" class="container-board">
				<div class="row mt-3 my-3">
					<div class="list-group">
						<h1 class="introduce-container">검색 결과</h1>
						<%-- SearchBean에서 searchType과 searchText를 가져옵니다 --%>
						<%
						SearchBean searchBean = new SearchBean();
						searchBean.setSearchType(request.getParameter("searchType"));
						searchBean.setSearchText(request.getParameter("searchText"));

						String searchType = searchBean.getSearchType();
						String searchText = searchBean.getSearchText();

						if (searchText != null && !searchText.isEmpty()) {
							List<SharePostDTO> searchResults = new SharePostDAO().searchPosts(searchType, searchText);
							if (searchResults.isEmpty()) {
						%>
						<p>검색 결과가 없습니다.</p>
						<%
						} else {
						for (SharePostDTO post : searchResults) {
						%>
						
						<a href="shareView.jsp?postId=<%=post.getPostId()%>"
							class="list-group-item list-group-item-action"
							aria-current="true">
							<div class="d-flex w-100 justify-content-between">
								<p class="mb-1">
									<span><%=post.getTitle()%> </span> 
									<% int commentCount = new SharePostDAO().getCommentCount(post.getPostId()); %>
