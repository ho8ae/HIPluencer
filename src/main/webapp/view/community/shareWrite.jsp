...
<link href="../../css/share_board.css" rel="stylesheet" />
...
<body id="page-top">
					...
					<div class="card">
						<div class="card-body">
							<div class="font-weight-bold text-dark text-uppercase mb-1">
								게시글 작성</div>
							<hr>
							<form action="../../writeActionShare.jsp" method="post">
								<div class="mb-3">
								...
								<!-- Hidden input fields to store location information -->
								<input type="hidden" id="placeName" name="placeName"> <input
									type="hidden" id="roadAddressName" name="roadAddressName">
								...
								<div id="locateDiv" class="mb-3"></div>
									...
									<div class="option">
										<div>
											<form onsubmit="searchPlaces(); return false;">
												키워드 : <input type="text" value="힙합" id="keyword" size="15">
	...
	<script src="../../js/kakao_keyword.js"></script>
