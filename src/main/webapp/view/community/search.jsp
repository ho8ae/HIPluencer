					...
					<div class="collapse navbar-collapse" id="navbarResponsive">
						...
						<div class="dropdown">
							<a href="#"
								...
								<div>
									<svg data-jdenticon-value="닉네임 사진 뛰우는 곳" width="32" height="32"
										class="rounded-circle me-2"></svg>
								</div> <!--<img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle me-2">-->
				...
				<div class="row mt-3 my-3">
					<div class="list-group">
						...
						if (searchText != null && !searchText.isEmpty()) {
							List<CommunityDTO> searchResults = new CommunityDAO().searchPosts(searchType, searchText);
							if (searchResults.isEmpty()) {
						%>
						<p>검색 결과가 없습니다.</p>
						<%
						} else {
						for (CommunityDTO post : searchResults) {
						%>
