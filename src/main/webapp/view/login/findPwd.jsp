			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body p-4">
						...
						<form id="contactForm" action="../../reportAction.jsp"
							method="post">
					...
					<div class="row">
						<div class="p-5">
							<div class="text-center">
								...
								<p class="mb-4 text-black-50">가입하신 이메일을 입력하시면 새로운 비밀번호를
									보내드립니다.</p>
							</div>
							<form class="user_password" action="../../sendResetLink.jsp"
								method="post">
								<div class="form-group">
									<input name="email" class="form-control form-control-user"
										id="email" aria-describedby="emailHelp" type="email"
										placeholder="이메일 주소">
								</div>
								<div id="updatePwdBtn">
									<button type="submit"
										class="btn btn-secondary btn-user btn-block ">비밀번호
										재설정하기</button>
								</div>
							</form>
							<hr>
