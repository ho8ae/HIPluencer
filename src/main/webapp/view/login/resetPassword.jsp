		...
		<div class="container px-5">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
					...
					<li class="nav-item"><a class="nav-link me-lg-3"
						target="_blank" href="https://www.instagram.com/potato_zoayo">인스타그램</a></li>
				</ul>
						...
						<div class="row">
							<div class="p-5">
								...
								<form action="../../processResetPassword.jsp" method="post">
									...
									<div class="form-group">
									<button type="submit" class="btn btn-secondary btn-user btn-block">비밀번호 재설정</button>
									</div>
								</form>
								<hr>
								<div class="text-center">
									<a class="small" href="../login.jsp">로그인으로 돌아가기</a>
								</div>
							</div>
						</div>
					</div>
...
<!-- Mirrored from www.gamza-zoa.com/community/login/findPwd by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 May 2024 15:58:15 GMT -->
</html>
