...
<%
    ...
    int result = communityDAO.delete(postId);
    if (result > 0) {
        out.println("<script>alert('정상적으로 삭제되었습니다.'); location.href='./view/community/free.jsp';</script>");
    } else {
        out.println("<script>alert('삭제되는게 실패하였습니다.'); history.back();</script>");
    }
%>
